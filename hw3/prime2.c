...
int main (int argc, char *argv[])
{
	...
	int p , id;
	unsigned long long elapsed_time , low_value=0, high_value=0, size =0, prime = 3, n = 10000000000, index = 0, primeSize=0;
	char *marked;
		 ...
		 unsigned long long first,primeFirst;
			do {
	      		...
	      		first = (prime * prime - low_value)/2;
	   			...
	   			for (i = primeFirst; i < primeSize; i += prime) primeCollection[i] = 1;//prime; //For debugging
